...
const DEFAULT_BUDGET: Omit<BudgetItem, 'id'>[] = [
  { category: 'Venue & Catering', description: 'Venue rental fee', estimated: 115000, actual: 0, paid: 0 },
  { category: 'Venue & Catering', description: 'Catering / F&B minimum', estimated: 0, actual: 0, paid: 0 },
  { category: 'Photography', description: 'Wedding photographer', estimated: 8000, actual: 0, paid: 0 },
  { category: 'Videography', description: 'Wedding videographer', estimated: 5000, actual: 0, paid: 0 },
  { category: 'Flowers & Decor', description: 'Florals & centerpieces', estimated: 15000, actual: 0, paid: 0 },
  { category: 'Flowers & Decor', description: 'Lighting & décor rentals', estimated: 5000, actual: 0, paid: 0 },
  { category: 'Music', description: 'Band or DJ', estimated: 10000, actual: 0, paid: 0 },
  { category: 'Attire', description: 'Wedding dress & alterations', estimated: 8000, actual: 0, paid: 0 },
  { category: 'Attire', description: 'Bridesmaids & groomsmen attire', estimated: 3000, actual: 0, paid: 0 },
  { category: 'Hair & Makeup', description: 'Bride hair & makeup', estimated: 2000, actual: 0, paid: 0 },
  { category: 'Hair & Makeup', description: 'Bridal party hair & makeup', estimated: 2000, actual: 0, paid: 0 },
  { category: 'Cake & Desserts', description: 'Wedding cake', estimated: 2000, actual: 0, paid: 0 },
  { category: 'Transportation', description: 'Limo / car service', estimated: 2000, actual: 0, paid: 0 },
  { category: 'Transportation', description: 'Guest shuttles', estimated: 2000, actual: 0, paid: 0 },
  { category: 'Stationery', description: 'Invitations & save-the-dates', estimated: 1500, actual: 0, paid: 0 },
  { category: 'Stationery', description: 'Programs, menus & signage', estimated: 500, actual: 0, paid: 0 },
  { category: 'Officiant', description: 'Officiant fee', estimated: 800, actual: 0, paid: 0 },
  { category: 'Rehearsal Dinner', description: 'Rehearsal dinner venue & food', estimated: 5000, actual: 0, paid: 0 },
  { category: 'Gifts & Favors', description: 'Wedding favors', estimated: 1000, actual: 0, paid: 0 },
  { category: 'Gifts & Favors', description: 'Bridal party & parent gifts', estimated: 2000, actual: 0, paid: 0 },
  { category: 'Miscellaneous', description: 'Vendor tips (gratuity)', estimated: 3000, actual: 0, paid: 0 },
  { category: 'Miscellaneous', description: 'Contingency / emergency fund', estimated: 5000, actual: 0, paid: 0 },
]
